...
type AldevConfig struct {
	...
	API *struct { // must be filled if there's an API
		...
		DocPath   string // the relative path - including the filename - of the OpenAPI doc generated by the code, eg "data/api-doc.yaml"
		DocReport string // the relative path - including the filename - of the report generated bout the API doc (which is @ DocPath)
		Browser   string // the browser (eg "chromium") to use to open reports generated about the API
	}
